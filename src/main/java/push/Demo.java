...
public class Demo {
	...
	public void sendAndroidCustomizedcast() throws Exception {
		...
		customizedcast.setAlias("256", "CRM");
		customizedcast.setTicker("Android customizedcast ticker");
		customizedcast.setTitle("中文的title陈涛256");
		customizedcast.setText("Android customizedcast text陈涛");
	...
	public static void main(String[] args) {
		...
		Demo demo = new Demo("567b58e367e58e963b003909", "zjgvogu0vljt81se6y7ieyed8ixbwjzq");
		try {
